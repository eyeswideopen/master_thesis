...
if useTestData:
    inputFolder = os.path.join(os.path.dirname(__file__), '../../../data/test/u-net/')
    outputFolder = os.path.join(os.path.dirname(__file__), './output')
else:
    inputFolder = os.path.join(os.path.dirname(__file__), '../../../data/train/u-net/')
    outputFolder = os.path.join(os.path.dirname(__file__), './output')


volumeSlices = [f for f in sorted(os.listdir(inputFolder)) if os.path.isfile(
    os.path.join(inputFolder, f)) and "image" in f]
segmentationSlices = [f for f in sorted(os.listdir(inputFolder)) if os.path.isfile(
    os.path.join(inputFolder, f)) and "label" in f]
